...
@section('content_header')
    <div class="d-flex justify-content-end">
        <a href="{{ route('admin.franchisees.index') }}" class="btn btn-md btn-info" title="Adicionar novo registro">
...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{route('admin.franchisees.store')}}" enctype="multipart/form-data" onsubmit="return mySubmit()">
            @csrf
            <div class="card card-info" style="max-width:900px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de cadastro de franqueado:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-9">
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="form-group m-0">
                            <small>Permissões de acesso ao sistema: Pressione e segure tecla 'Ctrl' e, seguida clique sobre a opção para selecionar.</small>
