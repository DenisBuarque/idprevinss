...
@section('content')
    <div class="container-fluid">
        <form method="POST" action="{{ route('admin.franchisees.update', ['id' => $user->id]) }}" enctype="multipart/form-data" onsubmit="return mySubmit()">
            @csrf
            @method('PUT')
            <div class="card card-info" style="max-width: 900px; margin: auto">
                <div class="card-header">
                    <h3 class="card-title">Formulário de adição de franqueado:</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-9">
