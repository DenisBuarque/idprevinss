                ...
                <tbody>
                    @forelse ($actions as $action)
                        <tr>
                            ...
                            <td class="py-2">{{\Carbon\Carbon::parse($action->created_at)->format('d/m/Y H:m:s') }}</td>
                            <td class="py-2">{{\Carbon\Carbon::parse($action->updated_at)->format('d/m/Y H:m:s') }}</td>
                            <td class="py-2 px-2">
                                <a href="{{route('admin.actions.edit',['id' => $action->id])}}" class="btn btn-block btn-info btn-xs" title="Alterar registro">
